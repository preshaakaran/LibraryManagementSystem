...
# Variables
lf_bg = '#70c1e7'  # Left Frame Background Color
rtf_bg = '#71caf3'  # Right Top Frame Background Color
rbf_bg = '#71d8cd'  # Right Bottom Frame Background Color
btn_hlb_bg = '#98d8fa'  # Background color for Head Labels and Buttons
...
dd.configure(font=entry_font, width=12,bg = btn_hlb_bg)
dd.place(x=75, y=300)
...
# Right Bottom Frame
Label(RB_frame, text='BOOK INVENTORY', bg=rbf_bg, font=("Cambria", 15, 'bold'), ).pack(side=TOP, fill=X)
